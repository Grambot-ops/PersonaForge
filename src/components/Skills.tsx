...
> = {
  ...
  "Security & Monitoring": {
    key: "skills.catSecurity",
    icon: "shield",
    color: "text-primary",
  },
  "Programming & Automation": {
    key: "skills.catAutomation",
    icon: "code",
    color: "text-primary",
  },
  "SRE & Infrastructure": {
    key: "skills.catSreInfra",
    icon: "account_tree",
    color: "text-primary",
  },
};
...
const Skills: React.FC = () => {
  ...
  return (
    <section
      className="py-16 md:py-24 border-y border-border bg-transparent relative z-20 overflow-hidden"
      id="skills"
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div className="max-w-2xl">
            ...
            <p className="text-muted text-base leading-relaxed">
              {t(
                "skills.intro",
                "A comprehensive overview of the tools and platforms I leverage to build secure, scalable, and automated infrastructure.",
              )}
            </p>
          </div>
          ...
          >
            <div
              className="flex items-center gap-3 text-sm font-semibold text-foreground flex-shrink-0"
              role="listitem"
            >
            ...
            >
              <VscAzure
                className="text-2xl text-[#0089D6]"
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    <div
                      className={`w-10 h-10 rounded-xl bg-surface-raised border border-border-muted flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                    >
                      <span
